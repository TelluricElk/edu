...
object TrLab {
    /** Предложение для демонстрации — фиксированное, семь слов. */
    val words: List<String> = listOf("Маленький", "кот", "быстро", "поймал", "серую", "мышь", "ночью")
    ...
    val embeddings: Array<FloatArray> = arrayOf(
        floatArrayOf(0f, 0f, 1f, 0f, 0f, 1f), // Маленький — определение
        floatArrayOf(1f, 0f, 0f, 1f, 0f, 1f), // кот — существительное, одушевлённое
        floatArrayOf(0f, 0f, 1f, 0f, 0f, 1f), // быстро — наречие
        floatArrayOf(0f, 1f, 0f, 0f, 0f, 1f), // поймал — глагол
        floatArrayOf(0f, 0f, 1f, 0f, 0f, 1f), // серую — определение
        floatArrayOf(1f, 0f, 0f, 1f, 0f, 1f), // мышь — существительное, одушевлённое
