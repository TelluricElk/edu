...
Учебная реализация использует полный батч-градиент на каждом шаге вместо мини-батчей и оптимизатор Adam, что делает обучение более чувствительным к выбору learning rate, чем в промышленных реализациях.
